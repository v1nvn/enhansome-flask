# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 456,718 | 🐛 65 | 📅 2026-04-02 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,058 | 🐛 143 | 🌐 Python | 📅 2026-04-17 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-MongoRest](https://github.com/closeio/flask-mongorest) ⚠️ Archived - RESTful API framework wrapped around [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,353 | 🐛 348 | 🌐 Python | 📅 2026-03-10.
...
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,126 | 🐛 34 | 🌐 Python | 📅 2026-04-14 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 61 | 🌐 Python | 📅 2026-04-16 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
* [Flask-Rebar](https://github.com/plangrid/flask-rebar) ⭐ 236 | 🐛 52 | 🌐 Python | 📅 2026-02-03 - Combines Flask, [marshmallow](https://marshmallow.readthedocs.io/), and [OpenAPI](https://www.openapis.org/) for robust REST services.
...
* [SAFRS: Python OpenAPI & JSON:API Framework](https://github.com/thomaxxl/safrs) ⭐ 413 | 🐛 4 | 🌐 Python | 📅 2026-04-16 - SAFRS, which is an acronym for *S*ql*A*lchemy *F*lask-*R*estful *S*wagger, is meant to help developers create self-documenting JSON APIs for SQLAlchemy database objects and relationships.
...
* [Flask-SimpleLogin](https://github.com/flask-extensions/Flask-SimpleLogin) ⭐ 205 | 🐛 3 | 🌐 Python | 📅 2025-08-09 - Authentication.
...
* [Authomatic](https://github.com/authomatic/authomatic) ⭐ 1,051 | 🐛 64 | 🌐 Python | 📅 2025-12-12 - Framework agnostic library for Python web applications that simplifies authentication and authorization of users via OAuth and OpenID.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 434 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,516 | 🐛 554 | 🌐 Python | 📅 2026-04-17 support.
...
* [Flask-Excel](https://github.com/pyexcel-webwares/Flask-Excel) ⭐ 264 | 🐛 9 | 🌐 Python | 📅 2020-11-10 - Uses [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,280 | 🐛 10 | 🌐 Python | 📅 2025-12-10 to read, manipulate, and write data in different Excel formats: csv, ods, xls, xlsx and xlsm.
...
* [Pytest-Flask](https://github.com/pytest-dev/pytest-flask) ⭐ 500 | 🐛 17 | 🌐 Python | 📅 2026-04-13 - Pytest support for testing Flask applications.
...
* [Flask-Talisman](https://github.com/wntrblm/flask-talisman) ⭐ 85 | 🐛 6 | 🌐 Python | 📅 2024-04-17 - HTTPS and security headers.
...
* [Flask-GraphQL](https://github.com/graphql-python/flask-graphql) ⭐ 1,340 | 🐛 42 | 🌐 Python | 📅 2023-01-03 - GraphQL support.
* [Frozen-Flask](https://github.com/Frozen-Flask/Frozen-Flask) ⭐ 801 | 🐛 13 | 🌐 Python | 📅 2024-11-12 - Freezes a Flask application into a set of static files.
* [Flask-Babel](https://github.com/python-babel/flask-babel) ⭐ 451 | 🐛 20 | 🌐 Python | 📅 2024-08-07 - Support for internationalization (i18n) and localization (l10n).
* [Flask-Moment](https://github.com/miguelgrinberg/Flask-Moment) ⭐ 380 | 🐛 1 | 🌐 Python | 📅 2025-12-25 - Moment.js date and time formatting helpers for Jinja2 templates.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 4 | 🌐 Python | 📅 2026-04-18 - API monitoring, analytics, and request logging for Flask.
* [Flask-Shell2HTTP](https://github.com/Eshaan7/Flask-Shell2HTTP) ⭐ 190 | 🐛 13 | 🌐 Python | 📅 2024-11-22 - RESTful/HTTP wrapper for Python's subprocess API, so you can convert any command-line tool into a RESTful API service.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,422 | 🐛 3 | 🌐 Python | 📅 2026-04-09 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,341 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,845 | 🐛 685 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,948 | 🐛 263 | 🌐 Python | 📅 2026-04-09 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [React-Redux-Flask](https://github.com/dternyak/React-Redux-Flask) ⭐ 1,497 | 🐛 12 | 🌐 JavaScript | 📅 2021-07-13 - Boilerplate application for a Flask JWT Backend and a React/Redux Front-End with Material UI.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,821 | 🐛 283 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,494 | 🐛 749 | 🌐 Python | 📅 2026-04-13 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,611 | 🐛 225 | 🌐 Python | 📅 2026-04-08 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,805 | 🐛 468 | 🌐 Python | 📅 2026-04-18 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,309 | 🐛 202 | 🌐 Python | 📅 2026-04-12 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,660 | 🐛 36 | 🌐 Python | 📅 2026-04-16 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,055 | 🐛 873 | 🌐 Python | 📅 2026-04-17 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 403 | 🐛 110 | 🌐 Python | 📅 2026-04-17 - Live tracking, flight database, and competition framework.
* [PythonBuddy](https://github.com/ethanchewy/PythonBuddy) ⭐ 283 | 🐛 17 | 🌐 Python | 📅 2026-02-20 - Online Python Editor with live syntax checking and execution.
