# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,760 | 🐛 84 | 📅 2026-03-09 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,057 | 🐛 142 | 🌐 Python | 📅 2026-03-16 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,123 | 🐛 37 | 🌐 Python | 📅 2026-03-04 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 64 | 🌐 Python | 📅 2026-03-18 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,216 | 🐛 543 | 🌐 Python | 📅 2026-03-18 support.
...
* [Frozen-Flask](https://github.com/Frozen-Flask/Frozen-Flask) ⭐ 799 | 🐛 13 | 🌐 Python | 📅 2024-11-12 - Freezes a Flask application into a set of static files.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 217 | 🐛 1 | 🌐 Python | 📅 2026-03-14 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,346 | 🐛 3 | 🌐 Python | 📅 2026-03-08 - Hosted on GitHub.
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,848 | 🐛 687 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,945 | 🐛 258 | 🌐 Python | 📅 2026-03-13 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,749 | 🐛 273 | 🌐 Python | 📅 2026-03-04.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,284 | 🐛 742 | 🌐 Python | 📅 2026-03-18 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,523 | 🐛 222 | 🌐 Python | 📅 2026-03-17 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,787 | 🐛 463 | 🌐 Python | 📅 2026-03-18 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,290 | 🐛 206 | 🌐 Python | 📅 2026-03-18 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,661 | 🐛 28 | 🌐 Python | 📅 2026-03-14 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,033 | 🐛 839 | 🌐 Python | 📅 2026-03-18 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 403 | 🐛 110 | 🌐 Python | 📅 2026-03-16 - Live tracking, flight database, and competition framework.
