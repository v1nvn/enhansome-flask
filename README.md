# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,982 | 🐛 70 | 📅 2026-01-28 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,056 | 🐛 146 | 🌐 Python | 📅 2026-02-13 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,120 | 🐛 36 | 🌐 Python | 📅 2026-02-01 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 717 | 🐛 65 | 🌐 Python | 📅 2026-02-20 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
...
* [SAFRS: Python OpenAPI & JSON:API Framework](https://github.com/thomaxxl/safrs) ⭐ 413 | 🐛 3 | 🌐 Python | 📅 2026-02-19 - SAFRS, which is an acronym for *S*ql*A*lchemy *F*lask-*R*estful *S*wagger, is meant to help developers create self-documenting JSON APIs for SQLAlchemy database objects and relationships.
...
* [Authomatic](https://github.com/authomatic/authomatic) ⭐ 1,050 | 🐛 51 | 🌐 Python | 📅 2025-12-12 - Framework agnostic library for Python web applications that simplifies authentication and authorization of users via OAuth and OpenID.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 26,946 | 🐛 557 | 🌐 Python | 📅 2026-02-20 support.
...
* [Flask-Excel](https://github.com/pyexcel-webwares/Flask-Excel) ⭐ 264 | 🐛 9 | 🌐 Python | 📅 2020-11-10 - Uses [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,285 | 🐛 10 | 🌐 Python | 📅 2025-12-10 to read, manipulate, and write data in different Excel formats: csv, ods, xls, xlsx and xlsm.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 217 | 🐛 1 | 🌐 Python | 📅 2026-02-21 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,243 | 🐛 3 | 🌐 Python | 📅 2026-02-20 - Hosted on GitHub.
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,854 | 🐛 687 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,942 | 🐛 260 | 🌐 Python | 📅 2026-02-20 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,684 | 🐛 273 | 🌐 Python | 📅 2026-02-01.
...
* [Airflow](https://github.com/apache/airflow/tree/master/airflow/www) ⭐ 44,338 | 🐛 1,781 | 🌐 Python | 📅 2026-02-21
* [Redash](https://github.com/getredash/redash) ⭐ 28,236 | 🐛 741 | 🌐 Python | 📅 2026-02-20 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,460 | 🐛 222 | 🌐 Python | 📅 2026-02-13 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,777 | 🐛 461 | 🌐 Python | 📅 2026-02-20 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,271 | 🐛 208 | 🌐 Python | 📅 2026-02-20 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,662 | 🐛 29 | 🌐 Python | 📅 2026-02-18 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,024 | 🐛 836 | 🌐 Python | 📅 2026-02-19 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 402 | 🐛 111 | 🌐 Python | 📅 2026-02-20 - Live tracking, flight database, and competition framework.
