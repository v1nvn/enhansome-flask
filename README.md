# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 472,171 | 🐛 82 | 📅 2026-05-05 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,057 | 🐛 125 | 🌐 Python | 📅 2026-06-01 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 60 | 🌐 Python | 📅 2026-06-01 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
* [Flask-Rebar](https://github.com/plangrid/flask-rebar) ⭐ 235 | 🐛 53 | 🌐 Python | 📅 2026-05-28 - Combines Flask, [marshmallow](https://marshmallow.readthedocs.io/), and [OpenAPI](https://www.openapis.org/) for robust REST services.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 435 | 🐛 22 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,912 | 🐛 564 | 🌐 Python | 📅 2026-06-01 support.
...
* [Flask-Excel](https://github.com/pyexcel-webwares/Flask-Excel) ⭐ 262 | 🐛 9 | 🌐 Python | 📅 2020-11-10 - Uses [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,282 | 🐛 10 | 🌐 Python | 📅 2025-12-10 to read, manipulate, and write data in different Excel formats: csv, ods, xls, xlsx and xlsm.
...
* [Flask-Profiler](https://github.com/muatik/flask-profiler) ⭐ 754 | 🐛 44 | 🌐 Python | 📅 2022-12-02 - Endpoint analyzer/profiler.
...
* [Pytest-Flask](https://github.com/pytest-dev/pytest-flask) ⭐ 500 | 🐛 18 | 🌐 Python | 📅 2026-05-25 - Pytest support for testing Flask applications.
...
* [secure](https://github.com/TypeError/secure) ⭐ 1,040 | 🐛 4 | 🌐 Python | 📅 2026-04-30 - A lightweight library for defining and applying HTTP security headers consistently in Flask applications.
...
* [Flask-GraphQL](https://github.com/graphql-python/flask-graphql) ⭐ 1,339 | 🐛 41 | 🌐 Python | 📅 2023-01-03 - GraphQL support.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 222 | 🐛 3 | 🌐 Python | 📅 2026-05-30 - API monitoring, analytics, and request logging for Flask.
* [Flask-Shell2HTTP](https://github.com/Eshaan7/Flask-Shell2HTTP) ⭐ 190 | 🐛 14 | 🌐 Python | 📅 2024-11-22 - RESTful/HTTP wrapper for Python's subprocess API, so you can convert any command-line tool into a RESTful API service.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,597 | 🐛 3 | 🌐 Python | 📅 2026-05-31 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,342 | 🐛 17 | 🌐 Python | 📅 2026-04-13 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Discover Flask - Full Stack Web Development with Flask](https://github.com/realpython/discover-flask) ⭐ 4,552 | 🐛 6 | 🌐 Python | 📅 2020-09-30
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,838 | 🐛 686 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,953 | 🐛 266 | 🌐 Python | 📅 2026-05-28 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,006 | 🐛 1 | 🌐 Python | 📅 2026-05-26 - Docker image with uWSGI and Nginx for Flask applications in Python running in a single container.
* [React-Redux-Flask](https://github.com/dternyak/React-Redux-Flask) ⭐ 1,496 | 🐛 12 | 🌐 JavaScript | 📅 2021-07-13 - Boilerplate application for a Flask JWT Backend and a React/Redux Front-End with Material UI.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,907 | 🐛 297 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,617 | 🐛 773 | 🌐 Python | 📅 2026-06-01 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,700 | 🐛 234 | 🌐 Python | 📅 2026-05-29 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,846 | 🐛 471 | 🌐 Python | 📅 2026-06-01 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,346 | 🐛 213 | 🌐 Python | 📅 2026-05-29 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,662 | 🐛 29 | 🌐 Python | 📅 2026-05-13 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,074 | 🐛 885 | 🌐 Python | 📅 2026-06-01 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 404 | 🐛 107 | 🌐 Python | 📅 2026-06-02 - Live tracking, flight database, and competition framework.
...
* [BOFS](https://github.com/colbyj/bride-of-frankensystem) ⭐ 14 | 🐛 5 | 🌐 Python | 📅 2026-05-25 - Create online surveys and behavioral experiments based on declarative configuration files; extend functionality via Flask as-needed.
