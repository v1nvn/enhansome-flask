# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 451,969 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,352 | 🐛 548 | 🌐 Python | 📅 2026-04-03 support.
...
* [Flask-GraphQL](https://github.com/graphql-python/flask-graphql) ⭐ 1,339 | 🐛 42 | 🌐 Python | 📅 2023-01-03 - GraphQL support.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,370 | 🐛 3 | 🌐 Python | 📅 2026-04-03 - Hosted on GitHub.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,795 | 🐛 284 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,325 | 🐛 743 | 🌐 Python | 📅 2026-04-01 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,567 | 🐛 225 | 🌐 Python | 📅 2026-04-02 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,797 | 🐛 467 | 🌐 Python | 📅 2026-04-04 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,302 | 🐛 201 | 🌐 Python | 📅 2026-04-02 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,659 | 🐛 32 | 🌐 Python | 📅 2026-03-30 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,049 | 🐛 852 | 🌐 Python | 📅 2026-04-02 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 403 | 🐛 110 | 🌐 Python | 📅 2026-04-03 - Live tracking, flight database, and competition framework.
