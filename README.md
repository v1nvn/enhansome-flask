# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 443,829 | 🐛 75 | 📅 2026-03-04 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,058 | 🐛 140 | 🌐 Python | 📅 2026-03-04 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-MongoRest](https://github.com/closeio/flask-mongorest) ⚠️ Archived - RESTful API framework wrapped around [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,349 | 🐛 348 | 🌐 Python | 📅 2025-09-02.
...
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 718 | 🐛 62 | 🌐 Python | 📅 2026-03-09 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
...
* [SAFRS: Python OpenAPI & JSON:API Framework](https://github.com/thomaxxl/safrs) ⭐ 413 | 🐛 4 | 🌐 Python | 📅 2026-03-08 - SAFRS, which is an acronym for *S*ql*A*lchemy *F*lask-*R*estful *S*wagger, is meant to help developers create self-documenting JSON APIs for SQLAlchemy database objects and relationships.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,147 | 🐛 542 | 🌐 Python | 📅 2026-03-08 support.
...
* [Pytest-Flask](https://github.com/pytest-dev/pytest-flask) ⭐ 500 | 🐛 16 | 🌐 Python | 📅 2026-02-23 - Pytest support for testing Flask applications.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,337 | 🐛 3 | 🌐 Python | 📅 2026-03-08 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,342 | 🐛 7 | 🌐 Python | 📅 2026-02-20 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,944 | 🐛 258 | 🌐 Python | 📅 2026-03-02 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,725 | 🐛 269 | 🌐 Python | 📅 2026-03-04.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,264 | 🐛 742 | 🌐 Python | 📅 2026-03-02 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,491 | 🐛 221 | 🌐 Python | 📅 2026-03-02 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,784 | 🐛 462 | 🌐 Python | 📅 2026-03-08 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,280 | 🐛 201 | 🌐 Python | 📅 2026-03-06 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,662 | 🐛 28 | 🌐 Python | 📅 2026-03-05 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,031 | 🐛 840 | 🌐 Python | 📅 2026-03-05 - Feature-rich event management system, made at [CERN](https://home.cern/).
