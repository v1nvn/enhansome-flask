# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 459,676 | 🐛 68 | 📅 2026-04-19 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,056 | 🐛 146 | 🌐 Python | 📅 2026-04-27 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,128 | 🐛 35 | 🌐 Python | 📅 2026-04-14 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 434 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,613 | 🐛 560 | 🌐 Python | 📅 2026-04-24 support.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 219 | 🐛 5 | 🌐 Python | 📅 2026-04-27 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,454 | 🐛 3 | 🌐 Python | 📅 2026-04-09 - Hosted on GitHub.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,839 | 🐛 287 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,540 | 🐛 752 | 🌐 Python | 📅 2026-04-19 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,631 | 🐛 227 | 🌐 Python | 📅 2026-04-08 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,805 | 🐛 471 | 🌐 Python | 📅 2026-04-27 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
...
* [Indico](https://github.com/indico/indico) ⭐ 2,063 | 🐛 873 | 🌐 Python | 📅 2026-04-27 - Feature-rich event management system, made at [CERN](https://home.cern/).
