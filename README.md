# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,684 | 🐛 61 | 📅 2026-04-02 with stars
...
* [Flasgger](https://github.com/flasgger/flasgger) ⭐ 3,740 | 🐛 285 | 🌐 Python | 📅 2024-06-17 - OpenAPI and Swagger UI. Builds the API from Flasgger models, marshmallow models, dicts, or YAML files.
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,124 | 🐛 35 | 🌐 Python | 📅 2026-04-01 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,430 | 🐛 547 | 🌐 Python | 📅 2026-04-09 support.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 3 | 🌐 Python | 📅 2026-04-08 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,407 | 🐛 3 | 🌐 Python | 📅 2026-04-09 - Hosted on GitHub.
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,946 | 🐛 264 | 🌐 Python | 📅 2026-04-09 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,807 | 🐛 284 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,327 | 🐛 745 | 🌐 Python | 📅 2026-04-01 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,803 | 🐛 466 | 🌐 Python | 📅 2026-04-09 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,305 | 🐛 202 | 🌐 Python | 📅 2026-04-10 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,659 | 🐛 32 | 🌐 Python | 📅 2026-03-30 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,052 | 🐛 863 | 🌐 Python | 📅 2026-04-09 - Feature-rich event management system, made at [CERN](https://home.cern/).
