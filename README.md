# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,689 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 434 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,305 | 🐛 545 | 🌐 Python | 📅 2026-03-27 support.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 1 | 🌐 Python | 📅 2026-03-28 - API monitoring, analytics, and request logging for Flask.
...
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,011 | 🐛 3 | 🌐 Python | 📅 2026-03-06 - Docker image with uWSGI and Nginx for Flask applications in Python running in a single container.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,779 | 🐛 275 | 🌐 Python | 📅 2026-03-04.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,311 | 🐛 741 | 🌐 Python | 📅 2026-03-19 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,553 | 🐛 224 | 🌐 Python | 📅 2026-03-25 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,793 | 🐛 465 | 🌐 Python | 📅 2026-03-28 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
...
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 403 | 🐛 109 | 🌐 Python | 📅 2026-03-29 - Live tracking, flight database, and competition framework.
...
* [ActorCloud](https://github.com/actorcloud/ActorCloud) ⭐ 195 | 🐛 56 | 🌐 Vue | 📅 2022-12-10 - Open-source IoT Platform.
