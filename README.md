# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,123 | 🐛 83 | 📅 2026-03-09 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,060 | 🐛 142 | 🌐 Python | 📅 2026-03-16 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 63 | 🌐 Python | 📅 2026-03-16 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,233 | 🐛 543 | 🌐 Python | 📅 2026-03-16 support.
...
* [Flask-Profiler](https://github.com/muatik/flask-profiler) ⭐ 756 | 🐛 44 | 🌐 Python | 📅 2022-12-02 - Endpoint analyzer/profiler.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,375 | 🐛 3 | 🌐 Python | 📅 2026-03-08 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,343 | 🐛 8 | 🌐 Python | 📅 2026-03-12 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,850 | 🐛 687 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,947 | 🐛 259 | 🌐 Python | 📅 2026-03-13 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,741 | 🐛 271 | 🌐 Python | 📅 2026-03-04.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,282 | 🐛 743 | 🌐 Python | 📅 2026-03-13 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,521 | 🐛 222 | 🌐 Python | 📅 2026-03-13 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,787 | 🐛 463 | 🌐 Python | 📅 2026-03-16 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,286 | 🐛 203 | 🌐 Python | 📅 2026-03-12 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,663 | 🐛 28 | 🌐 Python | 📅 2026-03-14 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,032 | 🐛 843 | 🌐 Python | 📅 2026-03-16 - Feature-rich event management system, made at [CERN](https://home.cern/).
