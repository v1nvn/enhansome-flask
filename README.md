# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 469,486 | 🐛 76 | 📅 2026-05-05 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,059 | 🐛 126 | 🌐 Python | 📅 2026-05-23 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-MongoRest](https://github.com/closeio/flask-mongorest) ⚠️ Archived - RESTful API framework wrapped around [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,350 | 🐛 347 | 🌐 Python | 📅 2026-03-10.
...
* [Flasgger](https://github.com/flasgger/flasgger) ⭐ 3,742 | 🐛 285 | 🌐 Python | 📅 2024-06-17 - OpenAPI and Swagger UI. Builds the API from Flasgger models, marshmallow models, dicts, or YAML files.
* [APIFlask](https://github.com/apiflask/apiflask) ⭐ 1,129 | 🐛 35 | 🌐 Python | 📅 2026-05-03 - Integrates marshmallow for validation and serialization, and for OpenAPI generation with Swagger UI.
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 61 | 🌐 Python | 📅 2026-05-04 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
* [Flask-Rebar](https://github.com/plangrid/flask-rebar) ⭐ 235 | 🐛 52 | 🌐 Python | 📅 2026-02-03 - Combines Flask, [marshmallow](https://marshmallow.readthedocs.io/), and [OpenAPI](https://www.openapis.org/) for robust REST services.
...
* [SAFRS: Python OpenAPI & JSON:API Framework](https://github.com/thomaxxl/safrs) ⭐ 414 | 🐛 6 | 🌐 Python | 📅 2026-05-08 - SAFRS, which is an acronym for *S*ql*A*lchemy *F*lask-*R*estful *S*wagger, is meant to help developers create self-documenting JSON APIs for SQLAlchemy database objects and relationships.
...
* [Flask-SimpleLogin](https://github.com/flask-extensions/Flask-SimpleLogin) ⭐ 204 | 🐛 3 | 🌐 Python | 📅 2026-05-04 - Authentication.
...
* [Axioms-Flask-Py](https://github.com/axioms-io/axioms-flask-py) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2025-11-24 - OAuth2/OIDC authentication and authorization for Flask APIs. Supports authentication and claim-based fine-grained authorization (scopes, roles, permissions) using JWT tokens.
...
* [Authomatic](https://github.com/authomatic/authomatic) ⭐ 1,054 | 🐛 65 | 🌐 Python | 📅 2025-12-12 - Framework agnostic library for Python web applications that simplifies authentication and authorization of users via OAuth and OpenID.
* [Flask-Dance](https://github.com/singingwolfboy/flask-dance) ⭐ 1,015 | 🐛 49 | 🌐 Python | 📅 2024-06-07 - OAuth support via [OAuthLib](https://oauthlib.readthedocs.io/).
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 435 | 🐛 22 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,840 | 🐛 569 | 🌐 Python | 📅 2026-05-22 support.
...
* [Flask-DB](https://github.com/nickjj/flask-db) ⭐ 77 | 🐛 4 | 🌐 Python | 📅 2024-12-07 - Flask CLI extension that helps you migrate, drop, create and seed your SQL database.
* [Flask-Migrate](https://flask-migrate.readthedocs.io) - Handles SQLAlchemy database migrations via Alembic.

<!--lint ignore double-link-->

> Curious about the differences between Alembic, Flask-Alembic, Flask-Migrate, and Flask-DB? Review [this item](https://github.com/nickjj/flask-db#differences-between-alembic-flask-migrate-flask-alembic-and-flask-db) ⭐ 77 | 🐛 4 | 🌐 Python | 📅 2024-12-07 from Flask-DB's FAQ.

#### Other Tools

* [Flask-Excel](https://github.com/pyexcel-webwares/Flask-Excel) ⭐ 263 | 🐛 9 | 🌐 Python | 📅 2020-11-10 - Uses [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,282 | 🐛 10 | 🌐 Python | 📅 2025-12-10 to read, manipulate, and write data in different Excel formats: csv, ods, xls, xlsx and xlsm.
...
* [Flask-Profiler](https://github.com/muatik/flask-profiler) ⭐ 755 | 🐛 44 | 🌐 Python | 📅 2022-12-02 - Endpoint analyzer/profiler.
...
* [Pytest-Flask](https://github.com/pytest-dev/pytest-flask) ⭐ 500 | 🐛 18 | 🌐 Python | 📅 2026-05-18 - Pytest support for testing Flask applications.
...
* [flask-msearch](https://github.com/honmaple/flask-msearch) ⭐ 225 | 🐛 8 | 🌐 Python | 📅 2024-01-16 - Full-text search.
* [Flask-WhooshAlchemy3](https://github.com/blakev/Flask-WhooshAlchemy3) ⭐ 29 | 🐛 3 | 🌐 Python | 📅 2022-02-01 - Full-text search + Whoosh indexing capabilities for Flask-SQLAlchemy.
...
* [secure](https://github.com/TypeError/secure) ⭐ 1,039 | 🐛 4 | 🌐 Python | 📅 2026-04-30 - A lightweight library for defining and applying HTTP security headers consistently in Flask applications.
* [Flask-SeaSurf](https://github.com/maxcountryman/flask-seasurf/) ⭐ 195 | 🐛 20 | 🌐 Python | 📅 2025-09-04 - Cross-site request forgery (CSRF) prevention.
* [Flask-Talisman](https://github.com/wntrblm/flask-talisman) ⭐ 87 | 🐛 6 | 🌐 Python | 📅 2024-04-17 - HTTPS and security headers.
...
* [Flask-RQ](https://github.com/pallets-eco/flask-rq) ⭐ 231 | 🐛 1 | 🌐 Python | 📅 2025-06-14 - [RQ](https://python-rq.org/) (Redis Queue) integration.
...
* [Flask-GraphQL](https://github.com/graphql-python/flask-graphql) ⭐ 1,341 | 🐛 41 | 🌐 Python | 📅 2023-01-03 - GraphQL support.
* [Frozen-Flask](https://github.com/Frozen-Flask/Frozen-Flask) ⭐ 800 | 🐛 13 | 🌐 Python | 📅 2024-11-12 - Freezes a Flask application into a set of static files.
* [Flask-Babel](https://github.com/python-babel/flask-babel) ⭐ 453 | 🐛 20 | 🌐 Python | 📅 2024-08-07 - Support for internationalization (i18n) and localization (l10n).
* [Flask-Moment](https://github.com/miguelgrinberg/Flask-Moment) ⭐ 381 | 🐛 1 | 🌐 Python | 📅 2026-05-14 - Moment.js date and time formatting helpers for Jinja2 templates.
* [Flask-Injector](https://github.com/python-injector/flask_injector) ⭐ 283 | 🐛 15 | 🌐 Python | 📅 2024-05-08 - Adds support for dependency injection.
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 219 | 🐛 3 | 🌐 Python | 📅 2026-05-23 - API monitoring, analytics, and request logging for Flask.
* [Flask-Shell2HTTP](https://github.com/Eshaan7/Flask-Shell2HTTP) ⭐ 189 | 🐛 14 | 🌐 Python | 📅 2024-11-22 - RESTful/HTTP wrapper for Python's subprocess API, so you can convert any command-line tool into a RESTful API service.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,573 | 🐛 3 | 🌐 Python | 📅 2026-05-18 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,343 | 🐛 17 | 🌐 Python | 📅 2026-04-13 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Discover Flask - Full Stack Web Development with Flask](https://github.com/realpython/discover-flask) ⭐ 4,550 | 🐛 6 | 🌐 Python | 📅 2020-09-30
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,841 | 🐛 685 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,952 | 🐛 265 | 🌐 Python | 📅 2026-04-09 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
* [cookiecutter-flask](https://github.com/cookiecutter-flask/cookiecutter-flask) ⭐ 4,728 | 🐛 24 | 🌐 Python | 📅 2025-12-02 - With Bootstrap 4, asset bundling annd minification with webpack, starter templates, and registration/authentication.
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,006 | 🐛 1 | 🌐 Python | 📅 2026-05-22 - Docker image with uWSGI and Nginx for Flask applications in Python running in a single container.
* [React-Redux-Flask](https://github.com/dternyak/React-Redux-Flask) ⭐ 1,495 | 🐛 12 | 🌐 JavaScript | 📅 2021-07-13 - Boilerplate application for a Flask JWT Backend and a React/Redux Front-End with Material UI.
* [Flask-Bootstrap](https://github.com/esbullington/flask-bootstrap) ⭐ 211 | 🐛 1 | 🌐 JavaScript | 📅 2022-12-27 - Integrated SQLAlchemy, authentication, and Bootstrap frontend.
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,892 | 🐛 295 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,591 | 🐛 756 | 🌐 Python | 📅 2026-05-06 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,679 | 🐛 232 | 🌐 Python | 📅 2026-05-19 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,842 | 🐛 472 | 🌐 Python | 📅 2026-05-23 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,338 | 🐛 212 | 🌐 Python | 📅 2026-05-19 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,663 | 🐛 29 | 🌐 Python | 📅 2026-05-13 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,072 | 🐛 886 | 🌐 Python | 📅 2026-05-23 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 404 | 🐛 107 | 🌐 Python | 📅 2026-05-18 - Live tracking, flight database, and competition framework.
...
* [BOFS](https://github.com/colbyj/bride-of-frankensystem) ⭐ 14 | 🐛 5 | 🌐 Python | 📅 2026-05-22 - Create online surveys and behavioral experiments based on declarative configuration files; extend functionality via Flask as-needed.
