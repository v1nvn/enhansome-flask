# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 466,101 | 🐛 75 | 📅 2026-05-05 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,058 | 🐛 144 | 🌐 Python | 📅 2026-05-12 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 435 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,761 | 🐛 567 | 🌐 Python | 📅 2026-05-13 support.
...
* [Pytest-Flask](https://github.com/pytest-dev/pytest-flask) ⭐ 500 | 🐛 17 | 🌐 Python | 📅 2026-05-11 - Pytest support for testing Flask applications.
...
* [secure](https://github.com/TypeError/secure) ⭐ 1,028 | 🐛 4 | 🌐 Python | 📅 2026-04-30 - A lightweight library for defining and applying HTTP security headers consistently in Flask applications.
...
* [Flask-Moment](https://github.com/miguelgrinberg/Flask-Moment) ⭐ 381 | 🐛 1 | 🌐 Python | 📅 2026-05-13 - Moment.js date and time formatting helpers for Jinja2 templates.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 218 | 🐛 5 | 🌐 Python | 📅 2026-05-09 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,530 | 🐛 3 | 🌐 Python | 📅 2026-05-13 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,343 | 🐛 9 | 🌐 Python | 📅 2026-04-13 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,870 | 🐛 287 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,570 | 🐛 755 | 🌐 Python | 📅 2026-05-06 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,652 | 🐛 231 | 🌐 Python | 📅 2026-05-13 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,840 | 🐛 471 | 🌐 Python | 📅 2026-05-13 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,326 | 🐛 211 | 🌐 Python | 📅 2026-05-13 - Collaborative forensic timeline analysis.
