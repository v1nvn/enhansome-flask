# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 468,543 | 🐛 77 | 📅 2026-05-05 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,059 | 🐛 142 | 🌐 Python | 📅 2026-05-20 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 435 | 🐛 22 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,820 | 🐛 569 | 🌐 Python | 📅 2026-05-20 support.
...
* [Flask-Excel](https://github.com/pyexcel-webwares/Flask-Excel) ⭐ 263 | 🐛 9 | 🌐 Python | 📅 2020-11-10 - Uses [pyexcel](https://github.com/pyexcel/pyexcel) ⭐ 1,281 | 🐛 10 | 🌐 Python | 📅 2025-12-10 to read, manipulate, and write data in different Excel formats: csv, ods, xls, xlsx and xlsm.
...
* [secure](https://github.com/TypeError/secure) ⭐ 1,038 | 🐛 4 | 🌐 Python | 📅 2026-04-30 - A lightweight library for defining and applying HTTP security headers consistently in Flask applications.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 219 | 🐛 5 | 🌐 Python | 📅 2026-05-16 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,567 | 🐛 3 | 🌐 Python | 📅 2026-05-18 - Hosted on GitHub.
...
* [Discover Flask - Full Stack Web Development with Flask](https://github.com/realpython/discover-flask) ⭐ 4,549 | 🐛 6 | 🌐 Python | 📅 2020-09-30
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,842 | 🐛 685 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,951 | 🐛 265 | 🌐 Python | 📅 2026-04-09 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,006 | 🐛 1 | 🌐 Python | 📅 2026-05-19 - Docker image with uWSGI and Nginx for Flask applications in Python running in a single container.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,888 | 🐛 292 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,586 | 🐛 756 | 🌐 Python | 📅 2026-05-06 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,670 | 🐛 232 | 🌐 Python | 📅 2026-05-19 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,842 | 🐛 470 | 🌐 Python | 📅 2026-05-20 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,335 | 🐛 213 | 🌐 Python | 📅 2026-05-19 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,663 | 🐛 29 | 🌐 Python | 📅 2026-05-13 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,071 | 🐛 882 | 🌐 Python | 📅 2026-05-19 - Feature-rich event management system, made at [CERN](https://home.cern/).
...
* [BOFS](https://github.com/colbyj/bride-of-frankensystem) ⭐ 14 | 🐛 5 | 🌐 Python | 📅 2026-05-14 - Create online surveys and behavioral experiments based on declarative configuration files; extend functionality via Flask as-needed.
