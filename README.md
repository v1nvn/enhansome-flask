# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,706 | 🐛 70 | 📅 2026-01-28 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,055 | 🐛 146 | 🌐 Python | 📅 2026-02-13 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 26,933 | 🐛 562 | 🌐 Python | 📅 2026-02-19 support.
...
* [Apitally](https://github.com/apitally/apitally-py) ⭐ 216 | 🐛 1 | 🌐 Python | 📅 2026-02-16 - API monitoring, analytics, and request logging for Flask.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,241 | 🐛 3 | 🌐 Python | 📅 2026-02-20 - Hosted on GitHub.
...
* [Flaskr TDD](https://github.com/mjhea0/flaskr-tdd) ⭐ 2,342 | 🐛 6 | 🌐 Python | 📅 2025-03-22 - Intro to Flask, Test-Driven Development (TDD), and JavaScript.
...
* [Zappa](https://github.com/Miserlou/Zappa) ⭐ 11,853 | 🐛 687 | 🌐 Python | 📅 2023-03-23
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,942 | 🐛 260 | 🌐 Python | 📅 2026-02-19 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) ⭐ 3,010 | 🐛 2 | 🌐 Python | 📅 2025-11-25 - Docker image with uWSGI and Nginx for Flask applications in Python running in a single container.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,682 | 🐛 273 | 🌐 Python | 📅 2026-02-01.
...
* [Airflow](https://github.com/apache/airflow/tree/master/airflow/www) ⭐ 44,326 | 🐛 1,756 | 🌐 Python | 📅 2026-02-20
* [Redash](https://github.com/getredash/redash) ⭐ 28,234 | 🐛 741 | 🌐 Python | 📅 2026-02-19 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,457 | 🐛 222 | 🌐 Python | 📅 2026-02-13 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,776 | 🐛 461 | 🌐 Python | 📅 2026-02-19 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,270 | 🐛 206 | 🌐 Python | 📅 2026-02-19 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,662 | 🐛 28 | 🌐 Python | 📅 2026-02-18 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,023 | 🐛 835 | 🌐 Python | 📅 2026-02-19 - Feature-rich event management system, made at [CERN](https://home.cern/).
* [SkyLines](https://github.com/skylines-project/skylines) ⭐ 402 | 🐛 150 | 🌐 Python | 📅 2026-02-19 - Live tracking, flight database, and competition framework.
