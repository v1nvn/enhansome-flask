# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,324 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Flask-Admin](https://github.com/pallets-eco/flask-admin) ⭐ 6,057 | 🐛 144 | 🌐 Python | 📅 2026-04-01 - Functional admin panel that provides a user interface for managing data based on your models.
...
* [Flask-MongoRest](https://github.com/closeio/flask-mongorest) ⚠️ Archived - RESTful API framework wrapped around [MongoEngine](https://github.com/MongoEngine/mongoengine) ⭐ 4,350 | 🐛 348 | 🌐 Python | 📅 2026-03-10.
...
* [flask-smorest](https://github.com/marshmallow-code/flask-smorest/) ⭐ 719 | 🐛 63 | 🌐 Python | 📅 2026-04-03 - Marshmallow's official Flask REST integration. Uses marshmallow models for request/response validation and serialization, and generates OpenAPI with Swagger UI.
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,358 | 🐛 549 | 🌐 Python | 📅 2026-04-03 support.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,372 | 🐛 3 | 🌐 Python | 📅 2026-04-05 - Hosted on GitHub.
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,944 | 🐛 265 | 🌐 Python | 📅 2026-04-02 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,797 | 🐛 284 | 🌐 Python | 📅 2026-04-01.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,326 | 🐛 744 | 🌐 Python | 📅 2026-04-01 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,571 | 🐛 225 | 🌐 Python | 📅 2026-04-02 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,799 | 🐛 468 | 🌐 Python | 📅 2026-04-05 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
...
* [Indico](https://github.com/indico/indico) ⭐ 2,051 | 🐛 853 | 🌐 Python | 📅 2026-04-02 - Feature-rich event management system, made at [CERN](https://home.cern/).
