# Awesome Flask [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 446,441 | 🐛 83 | 📅 2026-03-09 with stars
...
* [Flask-Pydantic](https://github.com/pallets-eco/flask-pydantic) ⭐ 433 | 🐛 21 | 🌐 Python | 📅 2025-12-22 - [Pydantic](https://github.com/pydantic/pydantic) ⭐ 27,210 | 🐛 543 | 🌐 Python | 📅 2026-03-17 support.
...
* [Source Code](https://github.com/pallets/flask) ⭐ 71,345 | 🐛 3 | 🌐 Python | 📅 2026-03-08 - Hosted on GitHub.
...
* [Flask-AppBuilder](https://github.com/dpgaspar/Flask-AppBuilder) ⭐ 4,946 | 🐛 259 | 🌐 Python | 📅 2026-03-13 - Simple and rapid application development framework that includes detailed security, auto CRUD generation for your models, Google charts, and much more.
...
* [Cookiecutter Flask Skeleton](https://github.com/testdrivenio/cookiecutter-flask-skeleton) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2020-02-29 - Flask starter project for [Cookiecutter](https://github.com/cookiecutter/cookiecutter) ⭐ 24,745 | 🐛 273 | 🌐 Python | 📅 2026-03-04.
...
* [Redash](https://github.com/getredash/redash) ⭐ 28,282 | 🐛 743 | 🌐 Python | 📅 2026-03-17 - Designed to enable anyone, regardless of the level of technical sophistication, to harness the power of data big and small.
* [SimpleLogin](https://github.com/simple-login/app) ⭐ 6,521 | 🐛 222 | 🌐 Python | 📅 2026-03-17 - Protect your online identity with email alias.
...
* [SecureDrop](https://github.com/freedomofpress/securedrop) ⭐ 3,787 | 🐛 464 | 🌐 Python | 📅 2026-03-17 - Open-source whistleblower submission system that media organizations can use to securely accept documents from, and communicate with anonymous sources.
* [Timesketch](https://github.com/google/timesketch) ⭐ 3,290 | 🐛 204 | 🌐 Python | 📅 2026-03-17 - Collaborative forensic timeline analysis.
* [FlaskBB](https://github.com/flaskbb/flaskbb) ⭐ 2,661 | 🐛 28 | 🌐 Python | 📅 2026-03-14 - Classic forum software.
* [Indico](https://github.com/indico/indico) ⭐ 2,031 | 🐛 843 | 🌐 Python | 📅 2026-03-17 - Feature-rich event management system, made at [CERN](https://home.cern/).
